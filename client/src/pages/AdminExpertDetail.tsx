          ...
          {isEditing ? (
            <SectionCard title="Education History">
              <EducationHistoryForm
                ...
                onAdd={(e) => addEducationMutation.mutate({ expertId: expertId!, schoolName: e.school, degree: e.degree, fieldOfStudy: "", startDate: e.startDate, endDate: e.endDate || undefined, description: e.description || undefined })}
                onUpdate={(e) => { if (e.id) updateEducationMutation.mutate({ id: parseInt(e.id), school: e.school, degree: e.degree, fieldOfStudy: "", startDate: e.startDate, endDate: e.endDate }); }}
